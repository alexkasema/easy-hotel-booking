...
test.beforeEach(async ({ page }) => {
    ...
    await page.locator("[name=email]").fill("john@email.com");
...
test("should allow user to add a hotel", async ({ page }) => {
    ...
    await page
      ...
      .fill("This is a description for the Motels");
...
test("should display hotels", async ({ page }) => {
  ...
  await expect(page.getByText("This is a description for the Motels")).toBeVisible();
